...
**Note: **
There are many ways to solve it, I prefer to use this way instead of looking for the index where the number appears again, because in a production line each toy will come out one after the other, and you can't know the future outputs.